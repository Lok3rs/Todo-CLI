...
def validate_add_task_arguments(sys_args: List) -> Union[int, Dict]:
    ...
    # Checks if there is required argument in sys_args, then if args are divisible by 2 (every argument needs to have
    # exactly 1 value, then if enough arguments was provided.
